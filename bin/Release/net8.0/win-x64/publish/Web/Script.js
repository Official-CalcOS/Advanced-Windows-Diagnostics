...
function displayReport(report) {
    ...
    document.getElementById('config-source').textContent = report.Configuration ? (report.Configuration.Source || 'Loaded (Web/appsettings.json or defaults)') : 'Defaults/Not Included';
